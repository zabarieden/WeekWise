...
// without this check, anyone who guesses/finds the webhook URL could trigger a
// sync for an arbitrary connection.
//
...
Deno.serve(async (req) => {
    ...
    try {
        ...
        if (!conn || conn.channel_token !== channelToken) {
        ...
        await pullDeltaForConnection(supabase, conn as any);
