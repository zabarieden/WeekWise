...
const FOOD_CALORIE_DB = [
    ...
    // עוד סוגי פיצה (ביתית/פיצרייה/קפואה/שוליים ממולאים/מגשים שלמים) - נתונים
    // מדויקים מהמשתמשת, כל אחד למשולש בודד אלא אם צוין אחרת. כולם חייבים
    // לבוא *לפני* פיצה הכללית בהמשך - מכילים "פיצה" כתת-מחרוזת
    ...
    { name: "מגש פיצה משפחתי", re: /מגש פיצה משפחתי|family pizza tray|whole family pizza/i, kcalPerUnit: 2400 },
    { name: "מגש פיצה אישי", re: /מגש פיצה אישי|personal pizza tray|whole personal pizza/i, kcalPerUnit: 900 },
