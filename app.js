...
const FOOD_LEFTOVER_IGNORE_RE = /^(עם|וגם|גם|ו|חצי|רבע|שליש|כפית|כפיות|כף|כפות|כוס|כוסות|גרם|גראם|מ["״]?ל|יחידה|יחידות|קטן|קטנה|גדול|גדולה|בינוני|בינונית|מנה|מנת|פרוסה|פרוסת|פרוסות|עוגיה|עוגייה|עוגיית|עוגיות|של|עוד|קצת|בערך)$/;
