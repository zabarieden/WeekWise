...
const FOOD_CALORIE_DB = [
    ...
    // פיתה קטנה/מיני חייבת לבוא *לפני* כל שאר ערכי הפיתה (מכילים "פיתה" כתת-
    // מחרוזת) - בלעדיה "פיתה קטנה כוסמין" הייתה נופלת לערך הפיתה הרגילה
    // הגדולה בהמשך (261 קל' במקום ~95, בדיוק הבאג שדווח). ~47 גרם/~95 קל'
    // ליחידה לפי נתון מדויק מהמשתמשת, תקף לכל סוגי הדגן (כוסמין/מקמח מלא/רגילה)
    { name: "פיתה קטנה", re: /פיתה קטנה|מיני פיתה|פיתת מיני|mini pita|small pita/i, kcal100g: 202, unitGrams: 47 },
    ...
    // זה ערך פיתה רגילה/גדולה, לא קטנה (ר' "פיתה קטנה" למעלה)
    ...
    { name: "לחמנית להמבורגר", re: /לחמנית (קלאסית )?להמבורגר|לחמניית (ה)?המבורגר|classic burger bun/i, kcalPerUnit: 180 },
    ...
    { name: "מגנום מיני", re: /מגנום מיני|מיני מגנום|שלגון מיני/i, kcalPerUnit: 160 },
    { name: "מגנום", re: /מגנום|magnum/i, kcalPerUnit: 315 },
